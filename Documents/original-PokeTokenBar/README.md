> **Archive.** This is the original [chattymin/PokeTokenBar](https://github.com/chattymin/PokeTokenBar) README, kept here so the fork still has the upstream product write-up. This repository's own README is at the [repo root](../../README.md).
