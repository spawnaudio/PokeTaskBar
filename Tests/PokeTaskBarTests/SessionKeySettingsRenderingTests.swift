...
final class SessionKeySettingsRenderingTests: XCTestCase {
    func testSessionKeyEntryOpensInsideViewportAndPreservesDifficultyControls() async throws {
        ...
        let settings = try String(
            contentsOf: root.appendingPathComponent("Sources/PokeTaskBar/UI/SettingsView.swift"),
            encoding: .utf8)
        let difficulty = try String(
            contentsOf: root.appendingPathComponent("Sources/PokeTaskBar/UI/DifficultySettingsSection.swift"),
            encoding: .utf8)
