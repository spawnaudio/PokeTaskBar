...
final class AntigravityUsageTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        temporaryDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("PokeTaskBar-AntigravityUsageTests-\(UUID().uuidString)")
    ...
    func testEntriesWithoutRootsGoesThroughResolvedRoots() throws {
        let source = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/PokeTaskBar/Core/LocalAntigravityUsageReader.swift")
