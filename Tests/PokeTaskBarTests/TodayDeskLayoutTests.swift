...
final class TodayDeskLayoutTests: XCTestCase {
    func testTodayIdentifiersStayOnLaunchWindowPolicy() {
        XCTAssertEqual(LaunchWindowPolicy.todayDeskIdentifier, "PokeTaskBar.TodayDesk")
        XCTAssertEqual(LaunchWindowPolicy.todayDeskAutosaveName, "PokeTaskBarTodayDesk")
