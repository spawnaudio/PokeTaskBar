...
final class ShinyCharmTests: XCTestCase {
    ...
    func testConstantsAndPassiveFlag() {
        XCTAssertEqual(ShinyCharm.price, EconomyScale.coins(3_000_000_000))
    ...
    func testBuyDeductsAndOwns() {
        ...
        XCTAssertEqual(s.availableCoins, 5_000_000 - ShinyCharm.price)
    }
    ...
    func testCanBuyNeedsEnoughTokens() {
        let s = store(used: EconomyScale.xpForCoins(ShinyCharm.price) - 1)
