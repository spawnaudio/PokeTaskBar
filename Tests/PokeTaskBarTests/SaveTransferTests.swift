...
final class SaveTransferTests: XCTestCase {
    ...
    func testNewerSchemaIsReportedEvenWhenTheBodyIsUnreadable() throws {
        let json = #"{"format":"poketaskbar.save","schema":99,"whatever":{"unknown":true}}"#
    ...
    /// completed. (PokeTaskBar.SaveTransferError error 0.)" 가 그대로 사용자에게 뜬다.
    ...
    func testSuggestedFileNameCarriesDate() {
        ...
        XCTAssertTrue(name.hasPrefix("PokeTaskBar-Save-"))
