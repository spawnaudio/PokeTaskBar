...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// PokeTaskBar v1 keeps an isolated Application Support folder. It does not
    /// import TokenMac or PokeTokenBar saves — those apps stay side-by-side.
