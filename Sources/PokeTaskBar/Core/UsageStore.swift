...
final class UsageStore {
    ...
    func refresh(scheduleEmptyRetry: Bool = true) async {
        ...
        let activity = ProcessInfo.processInfo.beginActivity(
            options: .userInitiatedAllowingIdleSystemSleep, reason: "PokeTaskBar usage refresh")
        defer {
    ...
    private(set) var linearRecentCompletedProjects: [LinearCompletedProject] = []
    ...
    func fetchLinearProjectsForCompanion() async -> [LinearCompletedProject] {
        _ = await refreshLinearIssues()
        return linearRecentCompletedProjects
    }
